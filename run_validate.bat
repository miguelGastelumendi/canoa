...
@echo Off
Rem cspell:ignore setlocal endlocal popd pushd venv py_args errorlevel enabledelayedexpansion qoutes findstr
...
Rem --------------------------------------------
echo Starting run_validate.bat v 2025-02-05 v4
...
:add_args
	...
	Rem set qoutes (removed by who knows who) if not is a flag (--)
	set "arg="%~1""
